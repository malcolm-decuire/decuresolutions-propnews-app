...
import type {VariantProps, CardProps} from "@nextui-org/react";
...
const chart = tv({
    ...
    variants: {
      color: {
        ...
        primary: {
          card: "bg-purple-900 text-white", // Dark Purple
          iconWrapper: "bg-purple-800 text-white",
          trendIconWrapper: "text-purple-300",
        },
        secondary: {
          card: "bg-purple-100 text-purple-900", // Light Purple
          iconWrapper: "bg-purple-200 text-purple-900",
          trendIconWrapper: "text-purple-700",
        },
        success: {
          card: "bg-blue-900 text-white", // Dark Blue
          iconWrapper: "bg-blue-800 text-white",
          trendIconWrapper: "text-blue-300",
        },
        warning: {
          card: "bg-blue-100 text-blue-900", // Light Blue
          iconWrapper: "bg-blue-200 text-blue-900",
          trendIconWrapper: "text-blue-700",
        },
        danger: {
          card: "bg-green-900 text-white", // Dark Green
          iconWrapper: "bg-green-800 text-white",
          trendIconWrapper: "text-green-300",
        },
      },
    },
    defaultVariants: {
                ...
                <defs>
                  <linearGradient id={"colorUv" + index} x1="0" x2="0" y1="0" y2="1">
                    <stop
                      offset="5%"
                      stopColor={cn({
                        "hsl(var(--nextui-foreground))": color === "default",
                        "hsl(var(--nextui-success))": color === "success",
                        "hsl(var(--nextui-danger))": color === "danger",
                        "hsl(var(--nextui-warning))": color === "warning",
                        "hsl(var(--nextui-secondary))": color === "secondary",
                        "hsl(var(--nextui-primary))": color === "primary",
                      })}
                      stopOpacity={0.2}
                    />
                    <stop
