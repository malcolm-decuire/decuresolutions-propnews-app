...
// export type NotificationType = "default" | "request" | "file" | "lawsuit";
...
export type NotificationType = "default" | "request" | "file" | "lawsuit" | "settlement";
  ...
  (
    ...
    const contentByType: Record<NotificationType, React.ReactNode> = {
      ...
      settlement: (
        <div className="flex flex-col gap-2">
          <p className="text-small text-foreground">
            <strong>Settlement with:</strong> {company}
          </p>
          <p className="text-small text-foreground">
            <strong>Industry:</strong> {industry}
          </p>
          <p className="text-small text-foreground">
            <strong>Settlement Amount:</strong> {fineAmount}
          </p>
          <p className="text-small text-foreground">
            <strong>Details:</strong> {details}
          </p>
