...
import NotificationsCard from "./DemoHeaderNav-notifications-card";
import GTMCard from "./DemoHeaderNav-GTMCard"
...
export default function Component() {
  return (
    ...
    >
      <NavbarBrand>
        <NavbarMenuToggle className="mr-2 h-6 sm:hidden" aria-label="" title="" />
      </NavbarBrand>
      <NavbarContent
      ...
      >
        <NavbarItem>
          <Link className="flex gap-2 text-inherit" href="/CaseStudies">
            Case Studies
          </Link>
        </NavbarItem>
      </NavbarContent>
