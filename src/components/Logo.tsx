...
// ///////////////////////////////////////////////////////////////////
// //20240630 chg for decure solutions 
// ///////////////////////////////////////////////////////////////////
...
export function Logo(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg aria-hidden="true" viewBox="0 0 100 50" {...props}>
      {/* Outer Circle */}
      <circle cx="25" cy="25" r="20" fill="lavender" stroke="lavender" strokeWidth="4" />

      {/* Inner Circle */}
      <circle cx="25" cy="25" r="18" fill="white" stroke="lavender" strokeWidth="4" />

      {/* Letter P */}
      <text x="17" y="32" fontSize="14" fontFamily="Arial" fontWeight="900" fill="lavender">
        P
      </text>

      {/* Letter N */}
      <text x="23.9" y="32" fontSize="14" fontFamily="Arial" fontWeight="900" fill="lavender">
        N
      </text>
    </svg>
  );
